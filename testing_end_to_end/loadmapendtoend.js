require(["esri/config","esri/Map", "esri/views/MapView", "esri/Graphic"], function (esriConfig, Map, MapView, Graphic) {
  ...
  $(document).ready(function(){
    ...
    // Printers
    // PRINTER NEEDS TO BE REFINED: CURRENTLY SHOWING SCANNERS AND OTHER STUFF TOO
      ...
      $.ajax({
        ...
        success: function(json_data){
          ...
          for (var i = 0; i < data_array.locations.location.length; i++) {
              ...
              addPoint(printer.geoloc.long, printer.geoloc.lat, [252,3,3], {name: printer.name, type:"Printer"});
          }
        }
      });
    });
