      ...
      $.ajax({
        ...
        success: function(json_data){
          ...
          for (var i = 0; i < data_array.length; i++) {
            ...
            point = createPoint(water_station.long, water_station.lat, [23, 162, 184], {name: water_station.building, type:"Bottle-Filling Station", building: water_station.building});
